...
import com.af.dateparser.generated.DateLexer;
import com.af.dateparser.generated.DateParser;
import com.af.dateparser.generated.DateWalker;
import com.af.dateparser.generated.TreeRewrite;
...
public class Parser {
  ...
  private static final Set<Integer> IGNORED_TRAILING_TOKENS =
      new HashSet<Integer>(Arrays.asList(DateLexer.DOT,
              DateLexer.COLON,
              DateLexer.COMMA,
              DateLexer.DASH,
              DateLexer.SLASH,
