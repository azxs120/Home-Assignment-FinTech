// $ANTLR 3.5.2 com\\af\\dateparser\\generated\\TreeRewrite.g 2021-10-03 17:30:21
...
public class TreeRewrite extends TreeRewriter {
	...
	@Override public String getGrammarFileName() { return "com\\af\\dateparser\\generated\\TreeRewrite.g"; }
	...
	// $ANTLR start "topdown"
	// com\\af\\dateparser\\generated\\TreeRewrite.g:32:1: topdown : ( ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK INT ) ^( DAY_OF_WEEK dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK $dow) ) | ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_MONTH INT ) ^( DAY_OF_MONTH dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_MONTH $dow) ) | ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR INT ) ^( MONTH_OF_YEAR dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR $dow) ) | ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR INT ) amount= INT ^( MONTH_OF_YEAR dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY $amount ^( MONTH_OF_YEAR $dow) ) | ^( SEEK DIRECTION SEEK_BY INT SPAN amt= INT span= SPAN ) -> ^( SEEK DIRECTION SEEK_BY $amt $span) | ^( RELATIVE_DATE ^( SEEK dir= DIRECTION seekby= SEEK_BY day= INT ^( MONTH_OF_YEAR month= INT ) ) ^( EXPLICIT_SEEK amount= INT ^( DAY_OF_WEEK dow= INT ) ) ^( EXPLICIT_SEEK ^( YEAR_OF year= INT ) ) ) -> ^( RELATIVE_DATE ^( SEEK $dir $seekby $day ^( MONTH_OF_YEAR $month) ) ^( EXPLICIT_SEEK ^( YEAR_OF $year) ) ^( EXPLICIT_SEEK $amount ^( DAY_OF_WEEK $dow) ) ) );
	@Override
	public final TreeRewrite.topdown_return topdown() throws RecognitionException {
		...
		try {
			// com\\af\\dateparser\\generated\\TreeRewrite.g:33:3: ( ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK INT ) ^( DAY_OF_WEEK dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK $dow) ) | ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_MONTH INT ) ^( DAY_OF_MONTH dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_MONTH $dow) ) | ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR INT ) ^( MONTH_OF_YEAR dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR $dow) ) | ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR INT ) amount= INT ^( MONTH_OF_YEAR dow= INT ) ) -> ^( SEEK DIRECTION SEEK_BY $amount ^( MONTH_OF_YEAR $dow) ) | ^( SEEK DIRECTION SEEK_BY INT SPAN amt= INT span= SPAN ) -> ^( SEEK DIRECTION SEEK_BY $amt $span) | ^( RELATIVE_DATE ^( SEEK dir= DIRECTION seekby= SEEK_BY day= INT ^( MONTH_OF_YEAR month= INT ) ) ^( EXPLICIT_SEEK amount= INT ^( DAY_OF_WEEK dow= INT ) ) ^( EXPLICIT_SEEK ^( YEAR_OF year= INT ) ) ) -> ^( RELATIVE_DATE ^( SEEK $dir $seekby $day ^( MONTH_OF_YEAR $month) ) ^( EXPLICIT_SEEK ^( YEAR_OF $year) ) ^( EXPLICIT_SEEK $amount ^( DAY_OF_WEEK $dow) ) ) )
			int alt1=6;
			...
			switch (alt1) {
				case 1 :
					// com\\af\\dateparser\\generated\\TreeRewrite.g:33:5: ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK INT ) ^( DAY_OF_WEEK dow= INT ) )
					{
					...
					// AST REWRITE
					// elements: SEEK_BY, INT, dow, DIRECTION, DAY_OF_WEEK, SEEK
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
					...
					{
						// com\\af\\dateparser\\generated\\TreeRewrite.g:34:10: ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_WEEK $dow) )
						{
						...
						// com\\af\\dateparser\\generated\\TreeRewrite.g:34:39: ^( DAY_OF_WEEK $dow)
						{
					...
					break;
				case 2 :
					// com\\af\\dateparser\\generated\\TreeRewrite.g:36:5: ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_MONTH INT ) ^( DAY_OF_MONTH dow= INT ) )
					{
					_last = (CommonTree)input.LT(1);
					{
					CommonTree _save_last_1 = _last;
					...
					// AST REWRITE
					// elements: SEEK_BY, DIRECTION, INT, dow, SEEK, DAY_OF_MONTH
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
					...
					{
						// com\\af\\dateparser\\generated\\TreeRewrite.g:37:10: ^( SEEK DIRECTION SEEK_BY INT ^( DAY_OF_MONTH $dow) )
						{
						CommonTree root_1 = (CommonTree)adaptor.nil();
						root_1 = (CommonTree)adaptor.becomeRoot(
						stream_SEEK.nextNode()
						...
						// com\\af\\dateparser\\generated\\TreeRewrite.g:37:39: ^( DAY_OF_MONTH $dow)
						{
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot(
					...
					break;
				case 3 :
					// com\\af\\dateparser\\generated\\TreeRewrite.g:39:5: ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR INT ) ^( MONTH_OF_YEAR dow= INT ) )
					{
					_last = (CommonTree)input.LT(1);
					{
					CommonTree _save_last_1 = _last;
					...
					// AST REWRITE
					// elements: INT, SEEK, SEEK_BY, dow, DIRECTION, MONTH_OF_YEAR
					// token labels: dow
					// rule labels: retval
					// token list labels: 
					// rule list labels: 
					...
					{
						// com\\af\\dateparser\\generated\\TreeRewrite.g:40:10: ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR $dow) )
						{
						CommonTree root_1 = (CommonTree)adaptor.nil();
						root_1 = (CommonTree)adaptor.becomeRoot(
						stream_SEEK.nextNode()
						...
						// com\\af\\dateparser\\generated\\TreeRewrite.g:40:39: ^( MONTH_OF_YEAR $dow)
						{
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot(
					...
					break;
				case 4 :
					// com\\af\\dateparser\\generated\\TreeRewrite.g:42:5: ^( SEEK DIRECTION SEEK_BY INT ^( MONTH_OF_YEAR INT ) amount= INT ^( MONTH_OF_YEAR dow= INT ) )
					{
					_last = (CommonTree)input.LT(1);
					{
					CommonTree _save_last_1 = _last;
					...
					// AST REWRITE
					// elements: dow, SEEK, SEEK_BY, amount, DIRECTION, MONTH_OF_YEAR
					...
					{
						// com\\af\\dateparser\\generated\\TreeRewrite.g:43:10: ^( SEEK DIRECTION SEEK_BY $amount ^( MONTH_OF_YEAR $dow) )
						{
						CommonTree root_1 = (CommonTree)adaptor.nil();
						root_1 = (CommonTree)adaptor.becomeRoot(
						stream_SEEK.nextNode()
						...
						// com\\af\\dateparser\\generated\\TreeRewrite.g:43:43: ^( MONTH_OF_YEAR $dow)
						{
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot(
						stream_MONTH_OF_YEAR.nextNode()
					...
					break;
				case 5 :
					// com\\af\\dateparser\\generated\\TreeRewrite.g:45:5: ^( SEEK DIRECTION SEEK_BY INT SPAN amt= INT span= SPAN )
					{
					_last = (CommonTree)input.LT(1);
					{
					CommonTree _save_last_1 = _last;
					...
					// AST REWRITE
					// elements: SEEK, span, SEEK_BY, amt, DIRECTION
					...
					{
						// com\\af\\dateparser\\generated\\TreeRewrite.g:46:10: ^( SEEK DIRECTION SEEK_BY $amt $span)
						{
						CommonTree root_1 = (CommonTree)adaptor.nil();
						root_1 = (CommonTree)adaptor.becomeRoot(
						stream_SEEK.nextNode()
					...
					break;
				case 6 :
					// com\\af\\dateparser\\generated\\TreeRewrite.g:49:5: ^( RELATIVE_DATE ^( SEEK dir= DIRECTION seekby= SEEK_BY day= INT ^( MONTH_OF_YEAR month= INT ) ) ^( EXPLICIT_SEEK amount= INT ^( DAY_OF_WEEK dow= INT ) ) ^( EXPLICIT_SEEK ^( YEAR_OF year= INT ) ) )
					{
					_last = (CommonTree)input.LT(1);
					{
					CommonTree _save_last_1 = _last;
					...
					// AST REWRITE
					// elements: month, EXPLICIT_SEEK, DAY_OF_WEEK, seekby, day, SEEK, MONTH_OF_YEAR, EXPLICIT_SEEK, year, amount, YEAR_OF, dow, dir, RELATIVE_DATE
					...
					{
						// com\\af\\dateparser\\generated\\TreeRewrite.g:54:8: ^( RELATIVE_DATE ^( SEEK $dir $seekby $day ^( MONTH_OF_YEAR $month) ) ^( EXPLICIT_SEEK ^( YEAR_OF $year) ) ^( EXPLICIT_SEEK $amount ^( DAY_OF_WEEK $dow) ) )
						{
						CommonTree root_1 = (CommonTree)adaptor.nil();
						root_1 = (CommonTree)adaptor.becomeRoot(
						stream_RELATIVE_DATE.nextNode()
						, root_1);
						// com\\af\\dateparser\\generated\\TreeRewrite.g:54:24: ^( SEEK $dir $seekby $day ^( MONTH_OF_YEAR $month) )
						{
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot(
						stream_SEEK.nextNode()
						...
						// com\\af\\dateparser\\generated\\TreeRewrite.g:54:49: ^( MONTH_OF_YEAR $month)
						{
						...
						// com\\af\\dateparser\\generated\\TreeRewrite.g:55:8: ^( EXPLICIT_SEEK ^( YEAR_OF $year) )
						{
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot(
						stream_EXPLICIT_SEEK.nextNode()
						, root_2);
						// com\\af\\dateparser\\generated\\TreeRewrite.g:55:24: ^( YEAR_OF $year)
						{
						CommonTree root_3 = (CommonTree)adaptor.nil();
						root_3 = (CommonTree)adaptor.becomeRoot(
						...
						// com\\af\\dateparser\\generated\\TreeRewrite.g:56:8: ^( EXPLICIT_SEEK $amount ^( DAY_OF_WEEK $dow) )
						{
						CommonTree root_2 = (CommonTree)adaptor.nil();
						root_2 = (CommonTree)adaptor.becomeRoot(
						stream_EXPLICIT_SEEK.nextNode()
						...
						// com\\af\\dateparser\\generated\\TreeRewrite.g:56:32: ^( DAY_OF_WEEK $dow)
						{
						CommonTree root_3 = (CommonTree)adaptor.nil();
						root_3 = (CommonTree)adaptor.becomeRoot(
						stream_DAY_OF_WEEK.nextNode()
